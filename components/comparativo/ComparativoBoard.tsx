...
import ComparativoBoardMount from "@/components/comparativo/ComparativoBoardMount"
    ...
    >
      <div className="comparativo-board-inner mx-auto flex w-full min-w-0 flex-col items-stretch">
        <header className="comparativo-header w-full shrink-0 self-stretch text-center">
          <h1 className="comparativo-header-title font-normal">ATELIER 430</h1>
          <ComparativoFlourish className="comparativo-ornament mx-auto mt-5" />
          <p className="comparativo-header-tagline">{copy.tagline}</p>
        </header>

        <div className="comparativo-gallery-scroll w-full min-w-0 self-stretch">
          <div
            className="comparativo-gallery-scroll-inner overflow-x-auto pb-1"
            style={{ WebkitOverflowScrolling: "touch" }}
          >
            <div
              className="comparativo-gallery shrink-0"
              style={{ width: galleryW, marginInline: "auto" }}
            >
                <div
                  ...
                  {items.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h2 className="comparativo-meta-title font-medium">{item.title}</h2>
                        ...
                        <p
                          className="comparativo-meta-price !text-[#8a6b3c]"
                          style={{ color: "#8a6b3c" }}
                        >
                          {formatPrice(item)}
                        </p>
        ...
        <footer className="comparativo-footer w-full shrink-0 self-stretch">
