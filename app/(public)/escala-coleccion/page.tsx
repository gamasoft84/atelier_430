...
export const metadata: Metadata = {
  ...
  description:
    "Comparación visual del tamaño real de las obras disponibles, con referencia humana de 164 cm y proporciones según las medidas de ficha.",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <header className="mb-8 max-w-3xl">
        ...
        <p className="text-sm text-stone-600 mt-3 leading-relaxed">
          ...
          <span className="font-medium text-carbon-900">164 cm</span> de altura para situar el volumen
